export const IPC = {
  ...
  GIT_MGR_PRUNE_WORKTREES: 'gitMgr:pruneWorktrees',
  ...
  WORKSPACE_ROUTE_OPEN_FILE: 'workspace:routeOpenFile',
  WORKSPACE_REDOCK_EDITOR: 'workspace:redockEditor',
  WORKSPACE_GET_EDITOR_WINDOW_STATE: 'workspace:getEditorWindowState',
  WORKSPACE_SET_PRIMARY_EDITOR: 'workspace:setPrimaryEditor',
  ...
  VOICE_DICTATE_START: 'voice:dictateStart',
  VOICE_DICTATE_STOP: 'voice:dictateStop',
  VOICE_DICTATE_CANCEL: 'voice:dictateCancel',
