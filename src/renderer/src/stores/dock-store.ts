...
interface DockState {
  ...
  pendingShellCommand: { command: string; submit: boolean; targetTerminalId: string | null; shellType: string | null; targetShellId: string | null } | null
  ...
  setPendingShellCommand: (command: { command: string; submit: boolean; targetTerminalId: string | null; shellType: string | null; targetShellId: string | null } | null) => void
