...
function App() {
  ...
  useEffect(() => {
    return getDockApi().shell.onRunCommand((command, submit, targetTerminalId, shellType, targetShellId) => {
      useDockStore.getState().setPendingShellCommand({ command, submit, targetTerminalId, shellType, targetShellId })
    })
  }, [])
