...
export class AwsProvider implements CloudProvider {
  ...
  async getSetupStatus(): Promise<CloudSetupStatus> {
    return {
      ...
      steps: [
        { id: 'install-cli', title: 'Install AWS CLI', description: 'Download and install the AWS CLI v2.', command: 'https://aws.amazon.com/cli/', helpUrl: 'https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html', helpLabel: 'Install AWS CLI', verifiable: true },
        { id: 'configure', title: 'Configure credentials', description: 'Run aws configure to set up your access key and region.', command: 'aws configure', helpUrl: 'https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-quickstart.html', helpLabel: 'Configuration docs', verifiable: true },
        { id: 'install-kubectl', title: 'Install kubectl', description: 'Install kubectl for Kubernetes management.', command: 'aws eks update-kubeconfig --name CLUSTER_NAME', helpUrl: 'https://docs.aws.amazon.com/eks/latest/userguide/install-kubectl.html', helpLabel: 'kubectl docs', verifiable: true }
      ],
